-- Migration: V1006__risk_overtime_flags.sql
-- Date: 2026-08-12
-- Author: 朱涛
...
-- 注：原 ddl/232_risk_overtime_flags.sql 未置于 Flyway 迁移目录，导致部署后缺失列；
--     此处纳入 Flyway（classpath:db/migration）以保证自动迁移。ADD COLUMN IF NOT EXISTS 幂等。
